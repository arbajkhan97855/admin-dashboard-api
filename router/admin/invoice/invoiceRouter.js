...
const { GetInvoice, SingleInvoice, CreateInvoice, UpdateInvoice, DeleteInvoice, SendInvoice, GenerateInvoicePDF } = require("../../../controller/invoice/invoiceController");
...
InvoiceRouter.post("/generate-pdf/:id", verifyToken, GenerateInvoicePDF);
